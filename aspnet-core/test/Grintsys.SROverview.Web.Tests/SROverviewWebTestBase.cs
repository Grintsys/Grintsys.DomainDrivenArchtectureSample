...
{
    public abstract class SROverviewWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SROverviewWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SROverviewWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SROverviewDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SROverviewDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SROverviewDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SROverviewDbContext, Task<T>> func)
        {
            T result;
